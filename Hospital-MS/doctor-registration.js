...
myApp.controller("registrationController", function ($scope, $http) {
    ...
    $scope.password = null;
    $scope.age = "Your Age";
    $scope.qualification = "Your Qualification";
    $scope.experience = "Your Experience";
    ...
    $scope.postdata = function (firstname, lastname, mobilenumber, email, gender, password, age, qualification,experience) {
        ...
        console.log(data);
        $http.post("https://b1afd516ad02.ngrok.io/doctor/register/", JSON.stringify(data))
            .then(function (res) {
                console.log(res);
            }).catch
    }
...
function validateQualification(a, b) {
    ...
    if (qualification == "Your Qualification") {
